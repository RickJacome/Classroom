...
print('A 20 kg base satellite deploys three sub-satellites, each which has its own thrust capabilities, to perform research on tether propulsion. The masses of sub-satellites, A, B and C, are 4 kg, 6 kg, and 8 kg, respectively, and their velocities expressed in m/s are given by v_A = 4i – 2j + 2k,  v_B = 1i + 4j, and v_C = 2i + 2j  + 4k.')
print('1 a) At the instant shown, calculate the i-component of the angular momentum H_o  [kg · m2 /s]  of the system about the base satellite. Rounded to the nearest integer.')

print('1 b) At the instant shown, calculate the j-component of the angular momentum H_o  [kg · m2 /s]  of the system about the base satellite. Rounded to the nearest integer.')

print('1 c) At the instant shown, calculate the k-component of the angular momentum H_o  [kg · m2 /s]  of the system about the base satellite. Rounded to the nearest integer.')

print('A system consists of three identical 19.32-lb particles A, B, and C. The velocities of the particles are, respectively, v_A = v_Aj, v_B = v_Bi, and v_C = v_Ck. Knowing that the angular momentum of the system about O expressed in ft-lb-s is H_o = 1.2k.')
print('2 a) Determine the velocity [ft/s] of particle A. Rounded to the nearest tenth.')

print('2 b) Determine the velocity [ft/s] of particle B. Rounded to the nearest tenth.')

print('2 c) Determine the velocity [ft/s] of particle C. Rounded to the nearest tenth.')

print('2 d) Calculate the angular momentum [ft-lb-s] component in the x-direction of the system about its mass center G. Rounded to the nearest tenth.')

print('2 e) Calculate the angular momentum [ft-lb-s] component in the y-direction of the system about its mass center G. Rounded to the nearest tenth.')

print('2 f) Calculate the angular momentum [ft-lb-s] component in the z-direction of the system about its mass center G. Rounded to the nearest tenth.')

print('Car A was traveling east at high speed when it collided at point O with car B, which was traveling north at 45 mi/h. Car C, which was traveling west at 60 mi/h, was 32 ft east and 10 ft north of point O at the time of the collision. Because the pavement was wet, the driver of car C could not prevent his car from sliding into the other two cars, and the three cars, stuck together, kept sliding until they hit the utility pole P. Knowing that the weights of cars A, B, and C are, respectively, 3000 lb, 2600 lb, and 2400 lb, and neglecting the forces exerted on the cars by the wet pavement, solve the problems indicated. Knowing that the speed of car A was 75 mi/h and that the time elapsed from the first collision to the stop at P was 2.4s.')
print('3 a) Determine the x-coordinate [ft] of the utility pole P. Rounded to the nearest tenth.')

print('3 b) Determine the y-coordinate [ft] of the utility pole P. Rounded to the nearest tenth.')
...
def final_sub(*ags, **kws):
	...
	try:
		round(((pnt1+pnt2+pnt3+pnt4+pnt5+pnt6+pnt7+pnt8+pnt9+pnt10+pnt11)/11)*100,1)
	except NameError:
		out_final.write(f"You did not finish submitting all questions above. Refresh Page and start again. ")
	grade = round(((pnt1+pnt2+pnt3+pnt4+pnt5+pnt6+pnt7+pnt8+pnt9+pnt10+pnt11)/11)*100,1)
