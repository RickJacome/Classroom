...
paraQ5a = Element("Q5a")
paraQ5a.write(f"5 a) The orbit of the planet Venus is nearly circular with an orbital velocity of {vi} x 10³ km/hr. Knowing that the mean distance from the center of the sun to the center of Venus is 108 x 10⁶ km and that the radius of the sun is {ri} x 10³ km. Determine the mass [x10³⁰ kg] of the sun. Rounded to the nearest integer. ")
